...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Brand orange color: #FBBF24 (rgb(251, 191, 36))
      // Normalize to 0-1 range and reduce intensity for subtle effect
      return {
        r: 0.98 * 0.3,  // 251/255 * 0.3 for subtle effect
        g: 0.75 * 0.3,  // 191/255 * 0.3
        b: 0.14 * 0.3   // 36/255 * 0.3
      };
    }
